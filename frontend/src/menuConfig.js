...
export const menuConfig = [
  ...
  },
  {
    ...
    children: [
      {
        name: "How to Contribute", action: () => window.runtime.BrowserOpenURL(
          "https://github.com/404NotFoundIndonesia/hyperion",
        )
      },
      {
        name: "Report Issue", action: () => window.runtime.BrowserOpenURL(
          "https://github.com/404NotFoundIndonesia/hyperion/issues",
        )
      }
    ]
  }
